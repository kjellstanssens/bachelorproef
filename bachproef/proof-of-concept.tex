...
\begin{itemize}
    ...
    \item \textbf{Queue}: De notificatiequeue is in deze \gls{PoC} geïmplementeerd als een database-tabel waarin de notificaties worden opgeslagen met een status aangezien deze gebundeld worden. Het gebruikte model voor deze queue staat in Listing~\ref{Notification Queue Model}.
...
Verder wordt er een strikt gecontroleerd welke domeinen toegang hebben tot de \gls{API}, door middel van de CORS-middleware in FastAPI.
