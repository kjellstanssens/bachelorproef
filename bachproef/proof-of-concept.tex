...
\subsection{Strategische Selectie van de Extractiemotor}
...
\begin{itemize}
    ...
    \item \textbf{Matcher}: De matcher is verantwoordelijk voor het toevoegen van notificaties aan de queue op basis van de gebruikersvoorkeuren. 
                            Deze functie \texttt{queue\_notifications\_for\_concert} (Listing~\ref{lst:notification-queueing}) controleert of er een gebruikersvoorkeur matcht met de venue of artiest van het concert.
