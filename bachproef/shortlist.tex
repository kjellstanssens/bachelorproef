...
Zoals besproken in de literatuurstudie, dwingen defensieve mechanismen zoals \textit{browser fingerprinting} en asynchrone \textit{\gls{CSR}} de noodzaak af van geavanceerde \textit{webscraping}-technieken.

Daarom werd voor de data-extractie voor Scrapling \autocite{Scrapling} gekozen, een geavanceerde \textit{webscraping}-tool die specifiek is ontworpen om deze uitdagingen aan te pakken. 
Scrapling is een zeer modern framework dat slechts sinds oktober 2024 bestaat en maakt gebruik van \textit{headless browsers}, \textit{fingerprint spoofing} en geavanceerde technieken om dynamische content te renderen en te extraheren, waardoor het effectief is in het omzeilen van \textit{browser fingerprinting} en het omgaan met asynchrone \textit{\gls{CSR}}. 
