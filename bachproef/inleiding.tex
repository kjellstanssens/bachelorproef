...
De primaire doelgroep van dit onderzoek zijn Vlaamse concertgangers (leeftijd 18-65) die momenteel ontevreden zijn over het handmatig controleren van websites. Een secundaire doelgroep zijn ontwikkelaars met interesse in \textit{change detection} systemen.
...
\begin{itemize}
    \item Welke \textit{web scraping} frameworks zijn het meest geschikt voor robuuste, periodieke monitoring van verschillende venue-websites?
...
In Hoofdstuk~\ref{ch:proof-of-concept} wordt de realisatie van de \gls{PoC} beschreven.

In Hoofdstuk~\ref{ch:resultaten-evaluatie} worden de resultaten van het prototype geanalyseerd en getoetst aan de evaluatiecriteria.
